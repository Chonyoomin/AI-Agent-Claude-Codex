...
Active. Initial VS Code entrypoint slice that adds thin task wrappers around the shipped CLI surfaces while preserving the repository's CLI-first runtime contract.
