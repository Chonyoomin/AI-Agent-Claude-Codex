...
Phase 10 - Future Product Features (sub-phase: Phase 10M - Desktop App Read-Only Runtime Initial Slice)
...
Active. This slice builds the first local read-only desktop app runtime over
the shipped external UI and dashboard view surfaces.
