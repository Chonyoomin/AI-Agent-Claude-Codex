...
Active. Narrow LangChain support-layer implementation slice on top of the shipped Phase 6N runtime-adapter seam and existing Phase 6 memory / checkpoint / continuation surfaces.
