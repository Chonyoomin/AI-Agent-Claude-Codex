...
Phase 10 - Future Product Features (sub-phase: Phase 10N - Desktop App Action Bridge Initial Slice)
...
Active. This slice adds the first bounded desktop action bridge over the
shipped external UI and desktop runtime surfaces.
